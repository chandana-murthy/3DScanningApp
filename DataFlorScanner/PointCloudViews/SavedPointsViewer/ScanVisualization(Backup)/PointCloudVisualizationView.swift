...
//      for large points use the combination 0.01, 1.0 and 5.0
        pointsGeometryElement.pointSize = 15.0
        pointsGeometryElement.minimumPointScreenSpaceRadius = 2.5
        pointsGeometryElement.maximumPointScreenSpaceRadius = 2.5
